...
// Hardcoded dummy data for the revenue chart (RM thousands)
const dummyChartData: number[] = [
  42, 48, 56, 61, 55, 68, 72, 78, 84, 76, 88, 95,
];
      ...
      custom({ series, seriesIndex, dataPointIndex, w }) {
        ...
        return `
          <div class="flex flex-col gap-2 p-3.5">
            <div class="font-medium text-sm text-secondary-foreground">${monthName} 2026 Revenue</div>
